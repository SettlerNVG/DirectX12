...
void LoadingState::OnEnter() {
    LOG_INFO("Entering Loading State - Preparing Resource Manager");
    m_timer = 0.0f;
    SetWindowTextW(m_app->GetWindowHandle(), L"Loading Resources...");
}
...
void LoadingState::Render() {
    ...
    // Рисуем текст "LOADING RESOURCES..." через GDI
    ...
    if (hdc) {
        ...
        TextOutW(hdc, 200, 250, L"LOADING RESOURCES...", 20);
