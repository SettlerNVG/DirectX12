...
#include "../Resources/HotReloadWatcher.h"
#include "Timer.h"
#include <Windows.h>
#include <memory>
#include <string>
...
public:
    ...
    ResourceManager* GetResourceManager() const { return &ResourceManager::GetInstance(); }
    HotReloadWatcher* GetHotReloadWatcher() const { return m_hotReloadWatcher.get(); }
...
private:
    ...
    std::unique_ptr<HotReloadWatcher> m_hotReloadWatcher;
    Timer m_timer;
};