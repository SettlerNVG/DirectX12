...
#include "../States/PhysicsGameplayState.h"
...
bool Application::Initialize(HINSTANCE hInstance, int width, int height) {
    ...
    LOG_INFO("=== Initializing Game Engine AID4.1 (Physics & Input) ===");
    ...
    m_stateManager->RegisterState("PhysicsGameplayState", std::make_unique<PhysicsGameplayState>(this));
...
bool Application::CreateAppWindow(HINSTANCE hInstance, int width, int height) {
    ...
    m_hwnd = CreateWindowEx(
        ...
        L"Game Engine - AID4.1 (Physics & Input)",
        WS_OVERLAPPEDWINDOW,
        ...
        case WM_KEYDOWN:
            if (wParam == VK_ESCAPE) {
                if (app) {
                    ...
                    if (currentState && currentState->GetName() == "PhysicsGameplayState") {
